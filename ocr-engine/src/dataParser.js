 ...
 */
export function parseOldDutchReceipt(text) {
    ...
    if (text.includes("DISTRIBUTOR'S SUMMARY")) {
        parseOldDutchSummary(result, lines);
    } else if (text.includes("DISTRIBUTOR'S GROSS PROFIT")) {
        parseOldDutchDistGrossProfit(result, lines);
    } else if (text.includes("PAYMENTS RECEIVED REPORT")) {
        parseOldDutchPaymentsReceived(result, lines);
    } else {
 ...
 */
function parseOldDutchPaymentsReceived(result, lines) {
 ...
 */
function parseOldDutchDistGrossProfit(result, lines) {
 ...
 */
function parseOldDutchSummary(result, lines) {
